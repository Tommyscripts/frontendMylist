              ...
              <v-menu open-on-hover>
                ...
                <v-list nav>
                  <v-list-item
                    ...
                    :key="index"
                    @click="agregarProducto(list.name, panaderia._id)"
                  >
                    <v-list-item-title>
                      {{ list.name }}
                    </v-list-item-title>
...
export default {
  ...
  async created() {
    ...
    if (Array.isArray(result)) {
      ...
      this.productos.forEach((el) => { if (el.categorias === "Panaderia") this.panaderias.push(el) })
    } else {
